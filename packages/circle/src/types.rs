...
#[contracttype]#[derive(Clone,Debug)]pub enum DataKey{Circle,Admin,Factory,Members,Contributions,Payouts,Bids,Votes,Dispute,FeeBps,Treasury,Allowlist,Token,Referrals,ReputationRegistry,OracleContract,FallbackOracle,EmrWithdrawals}
...
#[contracttype]#[derive(Clone,Debug)]pub struct ConfigUpdated{pub admin:Address,pub updated_at:u64}
#[contracttype]#[derive(Clone,Debug)]pub struct EmergencyWithdrawal{pub admin:Address,pub total_recovered:i128,pub distributed_to_members:i128,pub dust_to_admin:i128,pub timestamp:u64}
