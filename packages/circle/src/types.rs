...
#[contracttype]#[derive(Clone,Debug,PartialEq,Eq)]
pub enum PayoutType{Random=0,Fixed=1,Auction=2,Vote=3}
#[contracttype]#[derive(Clone,Debug,PartialEq,Eq)]
pub enum CircleFrequency{Daily=0,Weekly=1,Biweekly=2,Monthly=3}
#[contracttype]#[derive(Clone,Debug,PartialEq,Eq)]
pub enum CircleStatus{Pending=0,Active=1,Completed=2,Cancelled=3,Disputed=4}
#[contracttype]#[derive(Clone,Debug,PartialEq,Eq)]
pub enum MemberStatus{Active=0,Exited=1,Defaulted=2}
#[contracttype]#[derive(Clone,Debug,PartialEq,Eq)]
pub enum DisputeResolution{Dismiss=1,ForcePayout=3}
...
#[contracttype]#[derive(Clone,Debug)]
pub struct Circle{pub id:Address,pub token:Address,pub name:String,pub organizer:Address,pub factory:Address,pub contribution_amount:i128,pub max_members:u32,pub member_count:u32,pub payout_type:u32,pub total_rounds:u32,pub current_round:u32,pub status:CircleStatus,pub started_at:u64,pub created_at:u64,pub contribution_deadline_seconds:u64,pub min_moi_score:u32,pub collateral_amount:i128,pub penalty_bps:u32,pub grace_period_seconds:u64,pub max_strikes:u32,pub payout_bitmap:u128,pub total_payouts:i128,pub total_fees:i128,pub slug:String}
#[contracttype]#[derive(Clone,Debug)]pub struct Member{pub address:Address,pub position:u32,pub joined_at:u64,pub strikes:u32,pub status:MemberStatus,pub exited_at:u64,pub total_contributions:i128,pub total_received:i128}
...
#[contractevent]#[derive(Clone,Debug)]
pub struct DisputeRaised{pub member:Address,pub evidence_hash:BytesN<32>}
#[contractevent]#[derive(Clone,Debug)]
pub struct AuctionBidPlaced{pub bidder:Address,pub discount_bips:u32,pub round:u32}
#[contractevent]#[derive(Clone,Debug)]
pub struct VoteCast{pub voter:Address,pub vote_for:Address,pub round:u32}
#[contractevent]#[derive(Clone,Debug)]
pub struct ReferralRegistered{pub referrer:Address,pub referred:Address,pub bonus_pct:u32}
#[contractevent]#[derive(Clone,Debug)]
pub struct ReferralBonusPaid{pub referrer:Address,pub amount:i128}
#[contractevent]#[derive(Clone,Debug)]
pub struct StreakUpdated{pub member:Address,pub current_streak:u32,pub longest_streak:u32}
#[contractevent]#[derive(Clone,Debug)]
pub struct StreakBonusPaid{pub member:Address,pub amount:i128,pub streak:u32}
