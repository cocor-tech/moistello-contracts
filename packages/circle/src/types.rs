...
#[contracttype]#[derive(Clone,Debug,PartialEq)]
pub enum DisputeResolution{Dismiss=1,Penalize=2,ForcePayout=3}
#[contracttype]#[derive(Clone,Debug,PartialEq)]
...
#[contracttype]#[derive(Clone,Debug)]pub struct StorageVersion{pub version:u32}
