...
#[contracterror]#[derive(Debug,Clone,PartialEq,Eq)]pub enum TreasuryError{NotInitialized=1,Unauthorized=2,ContractPaused=3,InsufficientBalance=4,InvalidAmount=5,AlreadyInitialized=6,ContractNotPaused=7}
...
#[contracttype]#[derive(Clone,Debug)]pub struct TokensRescued{pub to:Address,pub token:Address,pub amount:i128}
