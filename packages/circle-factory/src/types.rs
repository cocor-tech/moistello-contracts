...
#[contracttype]#[derive(Clone)]pub enum DataKey{Admin,FeeConfig,CircleList,CircleCount,WasmHash,CircleConfig(Address),RateLimitConfig,OrganizerPeriodCount(Address,u64)}
#[contracttype]#[derive(Clone,Debug,PartialEq)]pub struct RateLimitConfig{pub limit:u32,pub period_secs:u64}
#[contracterror]#[derive(Debug,Clone,PartialEq,Eq)]pub enum FactoryError{NotInitialized=1,Unauthorized=2,ContractPaused=3,WasmHashNotSet=4,InvalidFeeBps=5,CircleDeployFailed=6,InvalidConfig=7,RateLimitExceeded=8}
