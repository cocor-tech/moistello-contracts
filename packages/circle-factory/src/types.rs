...
pub const MAX_DEPLOY_FEE: i128 = 100_000_000_000;
...
pub enum FactoryError {
    ...
    TemplateNotFound = 10,
    TemplateExists = 11,
    TemplateOutOfBounds = 12,
    InvalidTemplate = 13,
    DeployFeeExceedsCap = 14,
    InvalidTreasury = 15,
    FactoryConfigNotSet = 16,
    CircleConfigurationFailed = 17,
    InvalidAddress = 18,
}
...
#[contracttype]
#[derive(Clone, Debug, PartialEq)]
pub struct DeployFeeConfigUpdated {
    pub old_fee: i128,
    pub new_fee: i128,
