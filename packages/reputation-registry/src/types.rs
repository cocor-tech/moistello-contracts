...
#[contracttype]#[derive(Clone)]pub enum DataKey{Admin,Scores,Activity,Streak(Address,Address),Completions(Address),MemberScore(Address),Defaults(Address),MemberLog(Address)}
