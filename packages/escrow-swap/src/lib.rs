...
#[contractimpl]impl EscrowSwap{
    ...
    pub fn create_swap(env:Env,initiator:Address,responder:Address,token_a:Address,token_b:Address,initiator_amount:i128,responder_amount:i128,hash_lock:BytesN<32>,time_lock:u64)->Result<u64,types::EscrowError>{contract::create_swap(&env,&initiator,&responder,&token_a,&token_b,initiator_amount,responder_amount,hash_lock,time_lock)}
